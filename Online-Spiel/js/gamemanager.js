...
let gameManager = {
  ...
  resetSpieler: function(heldenTyp) {
    ...
    aktivierInterface.innerHTML =
      '<img src="Online-Spiel/bilder/' + heldenTyp.toLowerCase() + '.jpg" class="img-avatar"> <div> <h3> ' +
  ...
  setFight: function() {
    ...
    getGegner.innerHTML = '<img src="Online-Spiel/bilder/' + gegner.gegnerTyp.toLowerCase() + '.jpg" class="img-avatar"> <div> <h3> ' +
