...
let gameManager = {
  ...
  resetSpieler: function(heldenTyp) {
    ...
    aktivierInterface.innerHTML =
      '<img src="https://github.com/BuenyaminKarakaya/Portfolio/tree/main/Online-Spiel/bilder' + heldenTyp.toLowerCase() + '.jpg" class="img-avatar"> <div> <h3> ' +
  ...
  setFight: function() {
    ...
    getGegner.innerHTML = '<img src="https://github.com/BuenyaminKarakaya/Portfolio/tree/main/Online-Spiel/bilder' + gegner.gegnerTyp.toLowerCase() + '.jpg" class="img-avatar"> <div> <h3> ' +
