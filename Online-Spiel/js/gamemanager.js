...
let gameManager = {
  ...
  resetSpieler: function(heldenTyp) {
    ...
    aktivierInterface.innerHTML =
      '<img src="https://buenyaminkarakaya.github.io/Portfolio/bilder/' + heldenTyp.toLowerCase() + '.jpg" class="img-avatar"> <div> <h3> ' +
  ...
  setFight: function() {
    ...
    getGegner.innerHTML = '<img src="https://buenyaminkarakaya.github.io/Portfolio/bilder/' + gegner.gegnerTyp.toLowerCase() + '.jpg" class="img-avatar"> <div> <h3> ' +
